...
Provide a consistent, scalable pattern for organizing Minimal API endpoints in ASP.NET projects following ADR 0007 (Minimal APIs over Controllers).
...
- Delegate to handlers (see ADR 0006: CQRS recommendation).
